...
$xcrud->where('status =', 'Panitia');
$xcrud->where('periode_tahun =', $ais_periode_tahun);
$xcrud->table_name('AIS Panitia');
$xcrud->limit(20);

// Hide Fields
$xcrud->fields('kelompok,status,jurusan,pembayaran,sisa_pembayaran,ikut_travel', true);

// pass default and hide
$xcrud->pass_var('status', 'Panitia');
...
// custom kolom
$xcrud->columns('nama,email,nomor_paspor,scan_paspor');
