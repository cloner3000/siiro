								...
								<td>
									...
									<div id="<?php echo $row['id'] ?>" class="w3-modal">
										<div class="w3-modal-content w3-animate-top w3-card-4">
											<form method="post" action="conference_sertifikat_action.php" target="_blank">
											...
											<div class="w3-container">
												...
												<p>
													<label>Sebagai</label>
													<input type="text" name="status" class="w3-input w3-border" value="<?php echo $row['status'] ?>">
												</p>
...
<hr>
		<?php  
	}else{echo '<hr><div class="w3-padding w3-red"><h3><i class="fa fa-warning"></i> Data tidak di temukan !</h3></div>';}
}
?>
