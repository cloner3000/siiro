...
{
    // default connection
    public static $dbname = 'siiro'; // Your database name
    ...
    // theme and language
    public static $theme = 'defw3'; // can be 'default', 'bootstrap', 'minimal' or your custom. Theme of xCRUD visual presentation. For using bootstrap you need to load it on your page.
